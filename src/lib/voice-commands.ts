...
export const VOICE_COMMANDS: VoiceCommand[] = [
  ...
  {
    keywords: ['ลงทะเบียน', 'ขายน้ำมัน', 'ผลิตน้ำมัน', 'ลงขาย', 'สมัครขาย', 'ไบโอดีเซล'],
    action: 'REGISTER_OIL',
    description: 'ลงทะเบียนเป็นผู้ผลิตน้ำมันเชื้อเพลิง',
    example: 'ลงทะเบียนขายน้ำมันไบโอดีเซล',
  },
  {
    keywords: ['หาไบโอดีเซล', 'น้ำมันท้องถิ่น', 'น้ำมันทำเอง', 'หาน้ำมันเชื้อเพลิง', 'ดีเซลผสม'],
    action: 'FIND_OIL',
    description: 'ค้นหาน้ำมันเชื้อเพลิงท้องถิ่นใกล้เคียง',
    example: 'หาไบโอดีเซลใกล้ฉัน',
  },
];
...
export function getVoiceResponse(action: string, data?: Record<string, unknown>): string {
  switch (action) {
    ...
    case 'HELP':
      return 'พี่พูดคำสั่งง่ายๆ ได้เลยนะคะ เช่น หาปั๊ม, รายงาน, แจ้งเหตุ, นำทาง, ราคาน้ำมัน หรือ ลงทะเบียนขายน้ำมัน น้องหญิงช่วยได้หมดเลยจ้า!';
    case 'REGISTER_OIL':
      return 'เปิดหน้าลงทะเบียนให้แล้วค่ะ พี่กรอกข้อมูลร้านน้ำมันเชื้อเพลิงได้เลยนะคะ!';
    case 'FIND_OIL':
      return 'น้องหญิงกำลังหาผู้ผลิตน้ำมันเชื้อเพลิงใกล้พี่อยู่ค่ะ รอแป๊บจ้า!';
    default:
